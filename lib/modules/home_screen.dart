            ...
            children: [
              ...
              IconButton(
                  ...
                  icon: ImageIcon(AssetImage(!cubit.isPressedSearchIcon
                      ...
                      : 'assets/icons/search2.png'), color: Color(0xFFEBECED),
                    size: 30,)
              ),
            ],
          ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                      ...
                      Container(
                        ...
                        child: TextButton(
                            ...
                            child: Text('ACTION', style: TextStyle(fontSize: 15,
                                ...
                                color: selectedCategory[index] ? const Color(
                                    0xFFFFFFFF) : const Color(0xFF4B5363)),)),
                      ),
            ...
            const SizedBox(height: 30,),
            actorsListBuilder(context, 'BEST ACTORS'),
          ],
        ),
      ),
    );
