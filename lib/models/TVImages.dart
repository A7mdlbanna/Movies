...
class TvImages {
  ...
  TvImages.fromJson(dynamic json) {
...
TvImages copyWith({  List<Backdrops>? backdrops,
  int? id,
  List<Posters>? posters,
}) => TvImages(  backdrops: backdrops ?? _backdrops,
  id: id ?? _id,
...
class Posters {
  ...
  int? _voteCount;
  int? _width;
Posters copyWith({  double? aspectRatio,
  String? filePath,
  int? height,
  String? iso6391,
  double? voteAverage,
...
class Backdrops {
  ...
  int? _voteCount;
  int? _width;
Backdrops copyWith({  double? aspectRatio,
  String? filePath,
  int? height,
  dynamic iso6391,
  double? voteAverage,
